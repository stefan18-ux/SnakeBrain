...
def read_commands(file_path='file.txt'):
    """Read movement commands from a file."""
    try:
        with open(file_path, 'r') as f:
            commands = [line.strip().upper() for line in f.readlines()]
        return commands
...
def main():
    ...
    commands = read_commands('file.txt')
